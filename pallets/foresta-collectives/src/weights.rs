...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `ForestaCollectives::ManagerCollectives` (r:1 w:1)
	/// Proof: `ForestaCollectives::ManagerCollectives` (`max_values`: None, `max_size`: Some(850), added: 3325, mode: `MaxEncodedLen`)
	...
	fn add_collective() -> Weight {
		...
		Weight::from_parts(21_000_000, 4315)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(7_u64))
	}
	/// Storage: `ForestaCollectives::CollectivesMap` (r:1 w:0)
	/// Proof: `ForestaCollectives::CollectivesMap` (`max_values`: None, `max_size`: Some(152), added: 2627, mode: `MaxEncodedLen`)
	...
	/// Storage: `ForestaCollectives::MembersCount` (r:1 w:1)
	/// Proof: `ForestaCollectives::MembersCount` (`max_values`: None, `max_size`: Some(24), added: 2499, mode: `MaxEncodedLen`)
	/// Storage: `ForestaCollectives::Profile` (r:0 w:1)
	/// Proof: `ForestaCollectives::Profile` (`max_values`: None, `max_size`: Some(562), added: 3037, mode: `MaxEncodedLen`)
	fn add_member() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `343`
		//  Estimated: `3646`
